...
INSERT INTO `business` (`id`, `uid`, `user_id`, `name`, `slug`, `details`, `type`, `title`, `country`, `address`, `email`, `phone`, `category`, `business_type`, `logo`, `image`, `thumb`, `status`, `enable_gallery`, `enable_staff`, `is_primary`, `template_style`, `color`, `qr_code`, `date_format`, `time_format`, `time_interval`, `created_at`) VALUES
(1, '73104', 2, 'bargain-bin', 'bargain', '', 1, NULL, 186, NULL, 'admin@gmail.com', NULL, '2', NULL, NULL, NULL, NULL, 1, '1', '1', NULL, 1, '#546af1', 'uploads/files/qrcode_248309500.png', 'd M Y', 'hh', '30', '2021-10-07 19:16:33');
...
INSERT INTO `gallery` (`id`, `business_id`, `user_id`, `title`, `image`, `thumb`, `status`) VALUES
(1, 73104, 2, 'logo', 'uploads/medium/eeb3fb7080a1c87a03862621b0a662db_medium-360x101.png', 'uploads/thumbnail/eeb3fb7080a1c87a03862621b0a662db_thumb-200x56.png', 1);
...
(1, '40169', 2, '2', 'monthly', '20.00', 'verified', '2021-10-07', '2021-11-07', NULL, NULL, '0'),
(2, '', 2, '2', 'monthly', '20.00', 'verified', '2021-10-07', '2021-11-07', 'offline', 'proof_290875.png', '15');
...
CREATE TABLE `settings` (
  ...
  `offline_details` text CHARACTER SET utf8 DEFAULT NULL,
...
INSERT INTO `settings` (`id`, `site_name`, `site_title`, `favicon`, `logo`, `hero_img`, `keywords`, `description`, `footer_about`, `admin_email`, `mobile`, `copyright`, `pagination_limit`, `facebook`, `instagram`, `twitter`, `linkedin`, `google_analytics`, `site_color`, `site_font`, `layout`, `about_info`, `ind_code`, `purchase_code`, `link`, `enable_captcha`, `enable_workflow`, `enable_feature`, `enable_users`, `enable_blog`, `enable_faq`, `enable_registration`, `enable_payment`, `enable_paypal`, `enable_email_verify`, `enable_multilingual`, `captcha_type`, `captcha_site_key`, `captcha_secret_key`, `paypal_email`, `paypal_payment`, `stripe_payment`, `publish_key`, `secret_key`, `paypal_mode`, `twillo_account_sid`, `twillo_auth_token`, `twillo_number`, `enable_sms`, `enable_offline_payment`, `offline_details`, `mail_protocol`, `mail_title`, `mail_host`, `mail_port`, `mail_encryption`, `mail_username`, `mail_password`, `chart_style`, `country`, `site_info`, `lang`, `trial_days`, `tax_name`, `tax_value`, `type`, `version`) VALUES
(1, 'Bookmark', 'Booking Software', 'uploads/thumbnail/clock_thumb-128x128.png', 'uploads/medium/4da8e8b376f50d22125c66df5fc98f8a_medium-360x101.png', 'uploads/medium/imgonline-com-ua-ReplaceColor-0vOUYjkYa25X_big-626x626_medium-626x626.jpg', 'saas,appointment,booking,services', 'Simplifies appointment booking, helping you to manage business  in a smart way.', 'Bookmark is a complete SaaS based multi business service booking software, that gives your users the ability to create and manage bookings, staffs, services, customers, etc.', 'phenyo@one.io', '', '© 2021 All rights reserved.', 0, 'facebook', 'instagram', 'twitter', 'linkedin', '', '#ddd', 'Alata', 0, 'SW52YWxpZCBMaWNlbnNlIEtleQ==', '', '', 'aHR0cHM6Ly9jZG5qcy5jbG91ZGZsYXJlLmNvbS9hamF4L2xpYnMv', 0, 1, 1, 0, 1, 1, 1, 1, 1, 0, 0, NULL, '6LePpnMbAAAAAF9M3gPZehvReqSKSDzNjwKR2rMg', '6LePpnMbAAAAAJv2VCnkvvF5LTSBWj9BQypWUwRt', 'yourpaypal@gmail.com', 0, 0, 'pk_test_miL3pzy2WRveqVtkSvnAiyEk00TbcdiWmW', 'sk_test_zHkX8tpxqezUjxwKKrOENoKH00i4EnkxdN', 'live', 'ACe18ba19ed1df9246688a74d6bab688ae', '37d2c4648e2d7ab2dc50d294e22313f7', '', '0', '1', '<p style=\"line-height: 1;\">Enter your bank info to receive offline payments</p>', 'smtp', '', '', '', 'ssl', '', '', 'areaspline', 186, 2, 1, '14', 'Subscription Tax', '15', 'live', '0.5');
...
(1, 2, 73104, NULL, 'Mark One', 'mark-one', 'staff', 'phenyo@bargainbin.io', '$2y$10$wK/YONKqgvzfVK5SwNOiSOUIT0.9IBLI6q/b1YC5NmA9KK5hzHjVm', '012345679', 'assets/images/no-photo.png', 'assets/images/no-photo-sm.png', 1, '2021-10-07');
...
(1, 0, NULL, 'phenyo', 'phenyo@one.io', 'phenyo', '$2y$10$SwWNUQ.IbX2JLtzyOSsfdOTA/asFI2XunwunyjyccN7Og4uYFnlu.', 'admin', NULL, 'registered', '2021-10-07', NULL, NULL, 1, NULL, '0', '0', NULL, NULL, 1, 1, NULL, NULL, NULL, 1, NULL, 'USD', 'live', NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, '0', '0', 'd M Y', '2021-10-07 14:25:00'),
(2, 0, 'bargain-bin', 'bargain', 'admin@gmail.com', 'bargain', '$2y$10$XtKH8.PVX/qM6D2C.YXX7Oxj43v.t6q.cPLNEFDpdkOitNeYWygaq', 'user', NULL, 'registered', '2021-10-07', '+15675643', NULL, 0, '2703', '0', '0', NULL, 'assets/images/no-photo-sm.png', 0, 0, NULL, NULL, NULL, 1, NULL, 'USD', 'live', NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, '0', '0', 'd M Y', '2021-10-07 19:16:33');
