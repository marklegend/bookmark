        ...
        <div class="row">
            <?php $i=1; foreach ($packages as $package): ?>
              <div class="col-md-<?php echo(12/count($packages)) ?>" data-aos="fade-up" data-aos-delay="<?= $i*100;?>">
                <div class="pricing-table purple shadow-hover <?php if ($i == 2){echo "bg-primary-soft";} ?>">

                
                  <span class="package_titles badge badge-primary-soft badge-pill"><?php echo html_escape($package->name); ?> <?php echo trans('plan') ?></span>

                    <!-- Price -->
                    <div class="price-tag m-0 text-left">
                      <div class="yearly_price d-hide">
                          <span class="symbol h4 font-weight-bold"><?php echo settings()->currency_symbol ?></span>
