...
<head>
    ...
    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css?family=DM+Sans:300,400,500,600,700,800,900&amp;display=swap" rel="stylesheet">
    <!-- CSS Libs  -->
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/front/libs/easy-responsive-tabs/css/easy-responsive-tabs.css">
...
<body>
    ...
    <div class="main-wrapper">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-whites py-3">
                        ...
                        <div id="navbarContent" class="collapse navbar-collapse mt-2">
                            ...
                            <ul class="navbar-nav align-items-lg-center ml-auto">
                                ...
                                <li class="nav-item"><a href="<?php echo base_url('users') ?>" class="nav-link <?php if(isset($page_title) && $page_title == "Companies"){echo "active";} ?>"><?php echo trans('companies') ?></a></li>
                                <?php endif ?>
        ...
        <?php if (isset($page) && $page == 'Company'): ?>
            <header class="<?php if (isset($page_title) && $page_title == 'Company Home'){echo 'position-absolute';} ?> left-0 top-0 w-100">
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-light py-3">
                        <a class="navbar-brand mr-lg-5" href="<?php echo base_url($slug) ?>">
                            <?php if (!empty($company->logo)):?>
                                <img src="<?php echo base_url($company->logo) ?>" alt="logo">
                            <?php else: ?>
                                <span class="text-white"><?php echo html_escape($company->name) ?></span>
                            <?php endif; ?>
                        </a>
