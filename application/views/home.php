        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-12 col-lg-6 order-md-1 pr-lg-5 pr-xl-0 mb-8 mb-lg-0">
                    ...
                    <h1 data-aos="fade-left" data-aos-delay="250" class="display-4 font-weight-bold custom-fonts"><?php echo html_escape(settings()->site_name) ?> <?php echo trans('smart-booking-tool-to-grow-your-online-business') ?></h1>
                    ...
                    <?php if (settings()->trial_days != 0): ?>
                        <a href="<?php echo base_url('register?trial=start') ?>" class="btn btn-primary mt-3 btn-pill fs-14" data-aos="fade-left" data-aos-delay="350"><?php echo trans('start') ?> <?php echo settings()->trial_days; ?> <?php echo trans('days-free-trial') ?></a>
                    <?php endif ?>
                </div>
        ...
        <section>
            <div class="container">
                ...
                <div class="text-center mx-auto mb-8" data-aos="fade-up">
                    <h3 class="h3 custom-font"><?php echo trans('the-best-solution-to-start') ?></h3>
                </div>

                <!-- Feature box -->
                <div class="row">

                    <div class="col-sm-6 col-lg-3" data-aos="zoom-in-up" data-aos-delay="150">
                        <div class="card shadow-hover p-4 p-xl-6 text-center h-100">
                    ...
                    <div class="col-sm-6 col-lg-3 mb-5 mb-lg-0" data-aos="zoom-in-up" data-aos-delay="250">
                        <div class="card shadow-hover-1 transition-hover p-4 p-xl-6 text-center h-100 bg-secondary-soft">
                            <div class="card-body p-0">
                    ...
                    <div class="col-sm-6 col-lg-3 mb-5 mb-lg-0" data-aos="zoom-in-up" data-aos-delay="350">
                        <div class="card shadow-hover-1 transition-hover p-4 p-xl-6 text-center  h-100">
                            <div class="card-body p-0">
    ...
    <section>
        <div class="container">
            ...
            <div class="w-md-80 w-lg-50 text-center mx-auto mb-8 mb-lg-10" data-aos="fade-up">
                <h3 class="custom-font mb-1"><?php echo trans('workflow') ?></h3>
        ...
        <section class="bg-lights pt-6">
            <div class="container">
                <div class="text-center mb-5 mt-5 mb-lg-7 mt-0 mt-lg-5 mt-xl-0" data-aos="zoom-in-up">
                    <h3 class="h2 mb-3 mt-6 custom-font"><?php echo trans('learn-more-empower-yourself') ?></h3>
                </div>
    ...
    <section class="pt-3 get_started">
        <div class="container">
            ...
            <div class="text-center  pb-5 pt-5">
                ...
                <a href="<?php echo base_url('register') ?>" class="badge badge-primary badge-pill py-3" data-aos="fade-up" data-aos-delay="300"><?php echo trans('get-started') ?> <i class="fas fa-long-arrow-alt-right"></i></a>
            </div>
            </div>
        </div>
    </section>