                                    ...
                                    <tr id="row_<?php echo html_escape($appointment->id) ?>">
                                        ...
                                        <td>
                                            ...
                                            <span class="small badge badge-sm mb-0">
                                                <?php if ($appointment->price == 0): ?>
                                                    <?php echo trans('free') ?>
                                                <?php else: ?>
                                                    <?php echo get_currency_by_country($company->country)->currency_symbol; ?><?php echo number_format($amount, 2) ?>
                                                <?php endif ?>
                                            </span>
                                            <p class="mt-1"><span class="small badge badge-sm mb-0"><?php echo html_escape($appointment->duration) ?> min</span></p>
                                        </td>
                                        <td>
                                            <span class="badge badge-secondary-soft br-2"><i class="fas fa-calendar-alt"></i> <?php echo my_date_show($appointment->date) ?></span><br>
                                            <span class="mt-1 badge badge-secondary-soft br-2"><i class="fas fa-clock"></i> <?php echo html_escape($appointment->time) ?></span>
                                        </td>
                                        ...
                                        <td>
                                            <?php if (empty($appointment->pay_info) && $check_payment != true): ?>
                                                <a data-toggle="tooltip" data-title="<?php echo trans('complete-your-payment') ?>" data-placement="left" class="btn btn-light-primary btn-sm" data-id="<?php echo html_escape($appointment->id) ?>" href="<?php echo base_url('customer/payment/'.$appointment->id) ?>"><i class="fas fa-credit-card"></i></a>
                                            <?php endif ?>
                                            ...
                                            <?php if ($check_payment != true): ?>
                                                <a data-toggle="tooltip" data-title="<?php echo trans('cancel-appointment') ?>" data-placement="top" class="btn btn-light-danger btn-sm cancel_item" data-id="<?php echo html_escape($appointment->id) ?>" href="<?php echo base_url('customer/cancel/'.$appointment->id) ?>"><i class="fas fa-times-circle fs-12"></i></a>
                                            <?php endif ?>
