                            ...
                            <?php $a=1; foreach ($appointments as $appointment): ?>
                                <tr id="row_<?php echo html_escape($appointment->id) ?>">
                                    ...
                                    <td>
                                        ...
                                        <p class="mb-0 fs-13 text-muted"><?php echo html_escape($appointment->duration) ?> min</p>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <p class="mb-0"><span class="badge-custom badge-secondary-soft"><i class="far fa-clock"></i> <?php echo html_escape($appointment->time) ?></span></p>
                                    </td>
                                    ...
                                    <td>
                                      <p class="mb-1 fs-14">
                                          ...
                                          <span class="badge badge-primary-soft">
                                            <?php if ($appointment->price == 0): ?>
                                                Free
                                            <?php else: ?>
                                                <?php echo html_escape($this->business->currency_symbol) ?><?php echo number_format($amount, 2) ?>
                                            <?php endif ?>
                                          </span>
                                      ...
                                      <?php $check_payment = check_appointment_payment($appointment->id) ?>
                                        <?php if ($check_payment == true): ?>
                                          <p class="mb-1"><span class="badge badge-success"><i class="fas fa-check-circle"></i> <?php echo trans('verified') ?></span></p>
                                        <?php else: ?>
                                          <?php if ($appointment->price != 0): ?>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" role="menu" >
                                              ...
                                              <?php if ($appointment->customer_phone != '' && user()->twillo_account_sid != ''): ?>
                                                <a data-id="<?php echo html_escape($appointment->id); ?>" href="<?php echo base_url('admin/appointment/notify_customer/'.$appointment->id) ?>" class="dropdown-item notify_customer"><i class="lni lni-envelope mr-1"></i> Send SMS Reminder</a>
                                              <?php endif; ?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" required name="price" value="<?php echo number_format($amount, 2) ?>" disabled>
          </div>
        </div>
