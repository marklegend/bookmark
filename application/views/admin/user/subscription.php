                        ...
                        <ul class="nav nav-pills flex-column">
                            ...
                            <?php if (user()->user_type == 'trial'): ?>
                                <li class="nav-item active">
                                    <a href="#" class="nav-link">
                                        <?php echo trans('plan') ?> <span class="badge bg-secondary-soft float-right"><?php echo settings()->trial_days; ?> <?php echo trans('days-free-trial') ?></span>
                                    </a>
                                </li>
                            ...
                            <li class="nav-item active">
                                <a href="#" class="nav-link">
                                    <?php echo trans('plan') ?> <span
                                        class="badge bg-secondary-soft float-right"><?php echo html_escape($user->package_name) ?></span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item active">
                                <a href="#" class="nav-link">
                                    <?php echo trans('price') ?> <span
                                        class="badge bg-secondary-soft float-right"><?php echo html_escape(settings()->currency_symbol) ?><?php echo html_escape($user->amount) ?></span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item active">
                                <a href="#" class="nav-link">
                                    <?php echo trans('billing-cycle') ?> <span
                                        class="badge bg-secondary-soft float-right"><?php echo ucfirst(html_escape($user->billing_type)) ?></span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item active">
                                <a href="#" class="nav-link">
                                    <?php echo trans('last-billing') ?> <span
                                        class="badge bg-secondary-soft float-right"><?php echo my_date_show($user->created_at) ?></span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item active">
                                <a href="#" class="nav-link">
                                    <?php echo trans('expire') ?> <span
                                        class="badge bg-secondary-soft float-right"><?php echo my_date_show($user->expire_on).' ('.date_dif(date('Y-m-d'), $user->expire_on).' days left)' ?>
                                        </span>
                                </a>
                            </li>
                            <?php endif ?>
                            ...
                            <li class="nav-item active">
                                <a href="#" class="nav-link">
                                    ...
                                    <?php else: ?>
                                    <?php echo trans('payment-status') ?> <span class="badge badge-danger float-right"><i
