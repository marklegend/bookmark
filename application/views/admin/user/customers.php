              ...
              <form method="post" enctype="multipart/form-data" class="validate-form" action="<?php echo base_url('admin/customers/add')?>" role="form" novalidate>
                <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="emali" class="form-control" required name="email" placeholder="<?php echo trans('enter-email-for-username') ?>" value="<?php if(isset($customer[0]['email'])){echo html_escape($customer[0]['email']);} ?>" >
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="phone" value="<?php if(isset($customer[0]['phone'])){echo html_escape($customer[0]['phone']);} ?>" >
                    </div>
                                ...
                                <td class="actions">
                                  <div class="btn-group">
                                      ...
                                      <div class="dropdown-menu dropdown-menu-right" role="menu" >
                                        <a href="<?php echo base_url('admin/customers/edit/'.html_escape($row->id));?>" class="dropdown-item"><?php echo trans('edit') ?></a>
                                        <a data-val="Category" data-id="<?php echo html_escape($row->id); ?>" href="<?php echo base_url('admin/customers/delete/'.html_escape($row->id));?>" class="dropdown-item delete_item"><?php echo trans('delete') ?></a>
                                      </div>
                                  </div>
