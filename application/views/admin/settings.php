                  ...
                  <div class="col-md-3">
                    <div class="card-body">
                      <ul class="nav nav-pills flex-column" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" id="sms-tab" data-toggle="tab" href="#sms" role="tab" aria-controls="sms" aria-selected="false"><i class="far fa-comment-dots mr-1"></i> Twillo <?php echo trans('sms-settings') ?></a>
                        </li>
                        <li class="nav-item">
                        ...
                        <div class="tab-pane fade" id="mail" role="tabpanel" aria-labelledby="mail-tab">
                          ...
                          <div class="col-sm-12 mt-15">
                              ...
                              <div class="callout callout-default">
                                  <h4><i class="fa fa-envelope-o"></i> <?php echo trans('gmail-smtp') ?></h4>
