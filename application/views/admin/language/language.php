                    ...
                    <form id="cat-form" method="post" class="validate-form" action="<?php echo base_url('admin/language/add')?>" role="form" novalidate>
                        ...
                        <div class="form-group clearfix mt-4">
                          <div class="icheck-primary radio radio-inline d-inline mr-4 mt-2">
                            <input type="radio" id="radioPrimary1" value="ltr" name="text_direction" <?php if($language[0]['text_direction'] == 'ltr'){echo "checked";} ?> <?php if (isset($page_title) && $page_title != "Edit"){echo "checked";} ?>>
                            <label for="radioPrimary1"> LTR (Left to Right)
                            </label>
                          </div>

                          <div class="icheck-primary radio radio-inline d-inline">
                            <input type="radio" id="radioPrimary2" value="rtl" name="text_direction" <?php if($language[0]['text_direction'] == 'rtl'){echo "checked";} ?>>
                                            ...
                                            <td class="actions">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" role="menu" >
                                                      ...
                                                      <a href="<?php echo base_url('admin/language/edit/'.html_escape($lang->id));?>" class="dropdown-item">Edit</a>

                                                      <a data-val="Category" data-id="<?php echo html_escape($lang->id); ?>" href="<?php echo base_url('admin/language/delete/'.html_escape($lang->id));?>" class="dropdown-item delete_item">Delete</a>

                                                      <?php if ($lang->status == 1): ?>
                                                        <a href="<?php echo base_url('admin/language/deactive/'.html_escape($lang->id));?>" class="dropdown-item">Deactivate</a>
                                                      <?php else: ?>
                                                        <a href="<?php echo base_url('admin/language/active/'.html_escape($lang->id));?>" class="dropdown-item">Activate</a>
                                                      <?php endif ?>
                                                    </div>
                                                </div>
