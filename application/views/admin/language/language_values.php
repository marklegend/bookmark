        ...
        <div class="col-md-12">
          <div class="card input_area">
            ...
            <form method="post" class="validate-form" action="<?php echo base_url('admin/language/update_values/'.$type)?>" role="form" novalidate>
              ...
              <div class="row">
                <div class="col-sm-6">
                    <button type="submit" class="mb-10 btn btn-success btn-sm pull-<?php echo($settings->dir == 'rtl') ? 'right' : 'left'; ?> m-t-20"><i class="fas fa-check-circle"></i> <?php echo trans('update-values') ?></button>
                </div>
                <div class="col-sm-6">
