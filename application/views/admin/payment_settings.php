                      ...
                      <div class="card-body">
                          ...
                          <div class="form-group">
                              <div class="custom-control custom-switch">
                                  ...
                                  <label class="custom-control-label font-weight-bold" for="switch-1"> Paypal</label>
                              </div>
                          </div>
                      ...
                      <div class="card-body">
                          <div class="form-group">
                              <div class="custom-control custom-switch">
                                  ...
                                  <label class="custom-control-label font-weight-bold" for="switch-2"> Stripe</label>
                              </div>
                          </div>
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-md-8">
                      <div class="card-body">
                          <div class="form-group">
                              <div class="custom-control custom-switch">
                                  <input type="checkbox" value="1" name="enable_offline_payment" class="custom-control-input" id="switch-3" <?php if(settings()->enable_offline_payment == 1){echo "checked";} ?>>
                                  <label class="custom-control-label font-weight-bold" for="switch-3">  <?php echo trans('offline-payment') ?></label>
                              </div>
                          </div>
