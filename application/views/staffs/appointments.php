                                ...
                                <?php $a=1; foreach ($appointments as $appointment): ?>
                                    <tr id="row_<?php echo html_escape($appointment->id) ?>">
                                        ...
                                        <td>
                                            ...
                                            <span class="mt-1 badge badge-secondary-soft br-2"><i class="far fa-clock"></i> <?php echo html_escape($appointment->time) ?></span>
                                        </td>
                                        <td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="date" class="form-control bsdatepicker" required placeholder="Booking date" autocomplete="off" value="<?php echo html_escape($appointment->date); ?>">
